...
file_dir = '/media/cat/4TB/in_vivo/dan/M149873/2015-02-06_13-02-32_flash_CSD/'
#file_dir = '/media/cat/4TB/in_vivo/dan/M150566/2015-04-01_16-41-14_flashes_vis/'
#file_dir = '/media/cat/4TB/in_vivo/dan/M150566/2015-04-01_20-55-32_flashes_vis/'
#file_dir = '/media/cat/4TB/in_vivo/dan/M181420/181420_2015-04-07_13-25-07_flashes_vis/'
#file_dir = '/media/cat/4TB/in_vivo/dan/M181420/181420_2015-04-07_18-10-46_flash_vis/'
...
#data = oe.loadContinuous(file_dir+file_name)
...
#dt=dt.reshape(n_electrodes,len(dt)/n_electrodes)
...
exp_name = '_V1'  #Change this value to correct animal
ofname = file_dir #'/media/cat/4TB/in_vivo/dan/M149873/2015-02-06_13-02-32_flash_CSD/' 
hdf5file = h5py.File(ofname+exp_name+'.hdf5','w',libver='latest')
...
for i in ['CSD2','CSD3','DeepCSD4','DeepCSD5']: #Change list to required list
    ...
    grp.attrs['recording name']= 'Dan Denman CSD experiment'
