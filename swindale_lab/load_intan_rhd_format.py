...
def read_data(filename):
    ...
    if (data_present):
        ...
        #data['amplifier_data'] = np.multiply(0.195, (data['amplifier_data'].astype(np.int32) - 32768))      # units = microvolts; ORIGINAL LINE
        print "... subtracting data..."
        data['amplifier_data'] -= 32768      # units = microvolts
        print "... multiplying data..."
        data['amplifier_data'] *= np.float32(0.195)
        #data['amplifier_data'] /= np.uint64(0.195)
        ...
        # same notch filter to amplifier data here.-----------------------NOPE... NOT GONNA DO IT-------------------
        if False:
