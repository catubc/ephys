...
def Process_revcorr(spike_times,n_procs):
    pass




#************************* Theunisen lab code for ridge regression computation of STRF *************************
NULL = '\x00'
...
#def fit_strf_ridge(alpha):
def Parallel_fit_strf_ridge((args)): #ORIGINAL FUNCTION
    ...
    print "Fitting Toeplitz to output"
    rr.fit(A, output)
    etime = time.time() - stime
    if verbose:
    ...
    #return strf,bias  #ORIGINAL DATA RETURN
    return strf
